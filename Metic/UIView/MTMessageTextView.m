...
@implementation MTMessageTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [MTMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [MTMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [MTMessageTextView maxCharactersPerLine]) + 1;
}
