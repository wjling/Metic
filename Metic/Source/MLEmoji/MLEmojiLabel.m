...
REGULAREXPRESSION(PhoneNumerRegularExpression, @"^([\\s\\w:~!@$&*()|+<>',?-]{1,15} ):")
...
REGULAREXPRESSION_OPTION(PoundSignRegularExpression, @"", NSRegularExpressionCaseInsensitive)
...
//    [self initPlist];
    ...
    UIColor *commonLinkColor = [UIColor colorWithRed:46.0/255 green:171.0/255 blue:214.0/255 alpha:1.0f];//[UIColor colorWithRed:0.112 green:0.000 blue:0.791 alpha:1.000];
