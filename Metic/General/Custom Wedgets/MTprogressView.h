...
/**
 The ratio of the inner circle to the minimum side of MTprogressView,
...
/**
 The ratio of the outer circle to the minimum side of MTprogressView,
...
/**
 makes the outer faded out circle radius expand until it circumscribes the MTprogressView bounds
 */
