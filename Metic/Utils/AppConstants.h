...
enum Return_Code
{
    ...
    ADD_FRIEND_NOTIFICATION=999,
    ADD_FRIEND_RESULT=998,
    NEW_EVENT_NOTIFICATION=997,
    EVENT_INVITE_RESPONSE=996,
    REQUEST_EVENT=995,
    REQUEST_EVENT_RESPONSE=994,
    NEW_COMMENT_NOTIFICATION=993,
    NEW_PHOTO_NOTIFICATION=992,
